...
static uint8 iot_range_msg[]={0x41, 0x88, 0, 0x11, 0x22, 0xff, 0xff,TAG_SLOT,TAG_SLOT,0x63,0,0,0,0,0,0,0,0};
uint8 counter_an=0;
  ...
  dwt_rxenable(DWT_START_RX_IMMEDIATE);
     ...
     if (status_reg & SYS_STATUS_RXFCG)
     {
      ...
      //  counter_an=0;
        ...
        {
          if((anchor_addr[0]!=anchor_addr[1]) && (anchor_addr[0]!=anchor_addr[2]) && (anchor_addr[1]!=anchor_addr[2]))
          {
            dwt_write32bitreg(SYS_STATUS_ID, SYS_STATUS_TXFRS);
